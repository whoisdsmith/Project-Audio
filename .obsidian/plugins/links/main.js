    ...
    this.registerEvent(
      this.app.workspace.on("editor-menu", (menu, editor, view) => {
        ...
        if (linkData) {
          ...
          } else if (this.settings.contexMenu.addLinkText && linkData.link && (linkData.type & (2 /* Wiki */ | 1 /* Markdown */)) != 0) {
            menu.addItem((item) => {
...
var ObsidianLinksSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Add link text").setDesc("").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.contexMenu.addLinkText).onChange(async (value) => {
